...
function checking(editID) {
  ...
  function completedForm(curyear) {
    ...
    $("#example").DataTable({
      ...
      lengthChange: false,
      ajax: {
        url: `https://ijz2b76zn8.execute-api.ap-south-1.amazonaws.com/test/admission_child_personal/completed_form_status_year/${editID}/${curyear}`,
