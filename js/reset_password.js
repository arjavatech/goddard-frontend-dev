...
function signupFunction(){
    ...
    if (email_id != '' && password1 !='' && password2 !=''){
        ...
        if (password1 === password2) {
            ...
            // return false;
            $.ajax({
                url: "https://v2bvjzsgrk.execute-api.ap-south-1.amazonaws.com/test/parent_info/update_password",
                type: "PUT",
...
function resendmailFunction(){
    ...
    if (email_id != ''){
        $.ajax({
            url: `https://v2bvjzsgrk.execute-api.ap-south-1.amazonaws.com/test/forget_password_mail_trigger/${email_id}`,
            type: "GET",
            dataType: 'json',
            success: function (response) {
                console.log(response)
