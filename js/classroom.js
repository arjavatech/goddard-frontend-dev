...
//         console.log(json);
//         $.ajax({
//             url: "https://v2bvjzsgrk.execute-api.ap-south-1.amazonaws.com/test/ClassId_ClassName_info/add",
//             type: "POST",
...
//         console.log(json);
//         $.ajax({
//             url: "https://v2bvjzsgrk.execute-api.ap-south-1.amazonaws.com/test/ClassId_ClassName_info/update",
//             type: "PUT",
//             contentType: "application/json",
//             data: json,
//             success: function (response) {
...
form.addEventListener("submit", (e) => {
    ...
    let xhr = new XMLHttpRequest();
        ...
        xhr.open("POST", 'https://v2bvjzsgrk.execute-api.ap-south-1.amazonaws.com/test/class_details/create');
        ...
        if(editID != ''){
            ...
            new_element.addEventListener("submit", (e) => {
                ...
                //  sending post request to the server
                    ...
                    xhr.open("PUT", `https://v2bvjzsgrk.execute-api.ap-south-1.amazonaws.com/test/class_details/update/${editID}`);
                    xhr.setRequestHeader("Content-Type", "application/json");
                    xhr.send(json);
                }
            });
