...
function submitForm() {
    ...
    if (obj.child_first_name != '' && obj.child_last_name != '' && obj.class_id != '' && obj.class_id != null && obj.parent_id != '') {
        ...
        $.ajax({
            url: "https://zjnj2xrqwg.execute-api.ap-south-1.amazonaws.com/prod/child_info/create",
            type: "POST",
...
$(document).ready(function () {
    if (!isAuthenticated()) {
        ...
        //     $.ajax({
        //         url: 'https://zjnj2xrqwg.execute-api.ap-south-1.amazonaws.com/prod/parent_info/getall',
        //         type: 'get',
        //         datasrc: '',
        //         dataType: 'json',
